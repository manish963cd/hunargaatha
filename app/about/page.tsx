...
// ---- Data ----
// Corrected the data structure for Arjun Sharma by adding the 'socials' property.
const FOUNDERS = [
  {
    name: "Arjun Sharma",
    role: "Co-Founder & CEO",
...
    // Added a new 'socials' array to hold social links, addressing the TypeScript error.
    socials: [
      { icon: <i className="ri-twitter-x-line" />, url: "#" },
      { icon: <i className="ri-linkedin-box-fill" />, url: "#" }
    ]
  },
  {
    name: "Mohit Chuhan",
...
    // Added a 'socials' array for the second founder as well for consistency.
    socials: [
      { icon: <i className="ri-dribbble-line" />, url: "#" },
      { icon: <i className="ri-linkedin-box-fill" />, url: "#" }
    ]
  }
];
...
            {/* Corrected the rendering of social icons by checking if 'socials' exists */}
            {f.socials && f.socials.map((s, idx) => (
              <a
                key={idx}
                href={s.url}
                target="_blank"
...
              <p>
                Hunar Gatha is a digital platform dedicated to preserving and promoting India&expo;s rich 
...
      {/* Corrected Remixicon CDN link to ensure it's a valid and stable URL */}
